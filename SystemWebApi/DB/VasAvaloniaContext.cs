...
public partial class VasAvaloniaContext : DbContext
{
    public VasAvaloniaContext()
    {
    }

    public VasAvaloniaContext(DbContextOptions<VasAvaloniaContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=192.168.200.13;user=student;password=student;database=VasAvalonia", Microsoft.EntityFrameworkCore.ServerVersion.Parse("10.3.39-mariadb"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Credential>(entity =>
        {
            ...
            entity.HasIndex(e => e.Username, "Credential_UNIQUE").IsUnique();
